                ...
                <div class="tab-content">
					...
					<div class="full-box">
						...
						if(($day == "Wednesday") || ($day == "Thursday") || ($day == "Saturday")) {
									if(($slug != 'recent_sales') && ($slug != 'new_listing') && ($slug != 'off_market_home')){ ?>
										<div class="item">
                                            <a href="#" class="box1">
								  ...
								  if(($slug == 'off_market_home') && ($controler == 1)){?>
									  <div class="item box1">
                                                <h3><?php echo $name; ?></h3>
                                                <p> View properties before they are listed.<p>
                                                <a href="javascript:void(0)" id="seemore" >See More</a>
										</div>
