				...
				?> 
                    <div class="col-md-4">
                        <div class="paddington_box">
                            ...
                            <a class="c_ttl" href="#"><?php the_title(); ?></a>
                            ...
                            <div class="progress_bar">
                                ...
                                <div class="barWrapper">
                                    ...
                                    <div class="barWrapper">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo get_field('warm_score',$term); ?>" aria-valuemin="0" aria-valuemax="100">
                                                <span class="popOver" data-toggle="tooltip" data-placement="top" title="<?php echo get_field('warn_score',$term); ?>%"> </span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
