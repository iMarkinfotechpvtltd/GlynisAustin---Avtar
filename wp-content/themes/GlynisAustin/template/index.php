            ...
            <ul>
                <li>
                    <a href="<?php echo get_field('first_circle_source_link',6); ?>" class="">
                        <p>
                            <?php echo get_field('first_circle_content',6); ?>
                        </p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo get_field('second_circle_source_link',6); ?>">
                        <p>
                            <?php echo get_field('second_circle_content',6); ?>
                        </p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo get_field('third_circle_source_link',6); ?>">
                        ...
                        <p>
                            <?php echo get_field('third_circle_content',6); ?>
                        </p>
                    </a>
                </li>
            </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xs-12 pull-right">
                    <h2>About Us</h2>
                    <p>
                        <?php echo get_field('about_us_content',6);?>
                    </p>
                ...
                <?php
                    ...
                    <div class="item">
                        <div class="news_box">
                            ...
                            <div class="n_inner">
                                <a class="b_ttl" href="<?php the_permalink(); ?>">
                                    <?php the_title(); ?>
                                </a>
