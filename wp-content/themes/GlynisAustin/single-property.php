...
$cata_name = $name1[0];?>
    <section class="slider_prop_page" style="">
        <section class="slider_prop">
            <!-- <a class="atc" href="#">Add To Calender</a> -->
            <div class="fotorama" data-nav="thumbs" data-allowfullscreen="true" data-autoplay="true">
			...
			$arr=get_numerics($one);			
			 ...
			 foreach($arr as $val)
			 {
				 $small_image_url = wp_get_attachment_url($val, 'full');
				 $path1 = $path = $small_image_url;
				 $etx = pathinfo($path, PATHINFO_EXTENSION);  
				 ...
				 ?>
                        ...
                        <?php } else { ?>
                            <a href="<?php echo $path1; ?>?autoplay=1" data-video="true">
            ...
            <div class="row">
                    ...
                    <div class="section_left">
                        ...
                        <?php echo get_field('feature_of_property',$post_ID); ?>
							...
							$term = get_term( $id ,'property-category' );?>
                                ...
                                <?php $BC = get_field('body_corporate',$post->ID); 
								if($BC != "") {?>
                                    <div class="lft_div">
                                        BODY CORPORATE -
                                    </div>
                                    ...
                                    <?php } 
								$RA = get_field('rental_appraisal',$post->ID);
								if($RA != "") {
								?>
                                        <div class="lft_div">
                                            RENTAL APPRAISAL -
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="section_right">
                        <ul class="avlble_cat">
                            <li>
                                <?php echo get_field('number_of_bedroom',$post->ID); ?><i aria-hidden="true" class="fa fa-bed"></i></li>
                            <li>
