            ...
            <nav class="navbar navbar-default main_menu">
                ...
                <div class="pull-right">
                    <ul class="nav navbar-nav pull-left">
                        <li class="active"><a href="<?php echo get_site_url(); ?>">home <span class="sr-only">(current)</span></a></li>
                        <li class="dropdown">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu1">
                                ...
                                <li><a href="<?php echo get_site_url(); ?>/testimonial">OUR CLIENTS SAY</a></li>
                                <li><a href="#">RECENTLY SOLD</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu1">
                                <li><a href="<?php echo get_site_url(); ?>/local-news">LATEST NEWS</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu1">
                                ...
                                <li><a href="#">WHY GLYNIS AUSTIN</a></li>
                                <li><a href="<?php echo get_site_url(); ?>/team">THE TEAM</a></li>
